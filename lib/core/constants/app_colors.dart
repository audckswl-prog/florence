...
class AppColors {
  ...
  static const Color ivoryDark = Color(0xFFE0E0E0); // Darker shade for neumorphic shadows

  // Point Color (Action) - Dark Wine (#751013)
  static const Color burgundy = Color(0xFF751013); 
  static const Color burgundyLight = Color(0xFF9A2024); // Lighter shade for gradients
  ...
  static const Color greyLight = Color(0xFFAAAAAA); // Light grey for placeholders/icons
