...
Firenze(이하 "앱")는 이용자의 개인정보를 중요시하며, '개인정보 보호법' 등 관련 법령을 준수합니다.

1. 수집하는 개인정보 항목
앱은 원활한 서비스 제공을 위해 다음의 정보를 수집합니다.
- 계정 정보: 이메일 주소, 닉네임, 프로필 이미지
- 서비스 이용 데이터: 독서 기록(도서 정보, 읽기 상태, 날짜), 작성한 메모(텍스트, 사진)
- 자동 수집 항목: 기기 식별값(UUID), 모델명, OS 버전, 서비스 이용 기록(접속 로그 등)

2. 개인정보의 수집 및 이용 목적
수집된 정보는 다음의 목적을 위해서만 이용됩니다.
- 회원 식별 및 서비스 이용 권한 관리
- 개인 맞춤형 독서 통계 및 기록 관리 서비스 제공
- 친구 관계 형성 및 함께 읽기 참여 관리
- 서비스 오류 개선 및 안정성 향상

3. 기기 접근 권한의 이용
앱은 특정 기능을 제공하기 위해 아래의 기기 권한을 사용합니다. 각 권한은 사용자가 허용한 경우에만 수집/이용됩니다.
- 사진첩/갤러리 접근: 프로필 이미지 설정 및 메모에 사진을 첨부하기 위해 사용
- 카메라 접근: 도서 문장 스캔(OCR) 및 사진 촬영을 위해 사용
* 권한을 허용하지 않아도 해당 기능 외의 기본 서비스는 이용 가능합니다.
...
5. 개인정보의 파기 절차 및 방법
이용자가 회원 탈퇴를 진행할 경우, 앱은 수집된 모든 데이터를 서버에서 즉시 영구 삭제하며 복구가 불가능한 방법으로 파기합니다.
...
7. 개인정보 처리방침의 변경
본 방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경 내용의 추가, 삭제 및 교정이 있는 경우에는 앱 내 공지사항을 통해 고지합니다.
