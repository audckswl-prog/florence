...
class _CreateProjectScreenState extends ConsumerState<CreateProjectScreen> {
  ...
  Future<void> _createProject() async {
    ...
    if (_selectedBook == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('함께 읽을 책을 선택해주세요.')),
      );
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('새로운 독서 모임이 생성되었습니다!')),
        );
      }
    } catch (e) {
      if (mounted) {
                ...
                child: Row(
                  children: [
                    Icon(
                      ...
                      color: _selectedBook != null ? AppColors.burgundy : AppColors.grey,
                    ),
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(
                          color: _selectedBook != null ? AppColors.black : AppColors.greyLight,
            ...
            NeumorphicContainer(
              ...
              child: GestureDetector(
                ...
                child: Row(
                  children: [
                    Icon(
                      _selectedTargetDate != null ? Icons.calendar_today : Icons.calendar_month_outlined,
                      color: _selectedTargetDate != null ? AppColors.burgundy : AppColors.grey,
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Text(
                        _selectedTargetDate != null 
                            ...
                            : '언제까지 다 읽을까요?',
                        style: TextStyle(
                          color: _selectedTargetDate != null ? AppColors.black : AppColors.greyLight,
                          fontWeight: _selectedTargetDate != null ? FontWeight.bold : FontWeight.normal,
                        ),
                      ),
                    ),
                  ],
